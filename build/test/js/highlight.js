   ...
   ((e) => {
    if (Array.isArray(e.end)) {
     if (e.skip || e.excludeEnd || e.returnEnd)
      throw (
       (z("skip, excludeEnd, returnEnd not compatible with endScope: {}"), G)
      );
   ...
   function E(e, n, s, r) {
    ...
    function h(e, t) {
     return (
      ...
      e.beginScope &&
       (e.beginScope._wrap
        ? (u(R, w.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap),
          (R = ""))
 ...
 var e = (() => {
  ...
  return (e) => {
   ...
   function o(e) {
    return r.concat(
     /\b/,
     r.either(...e.map((e) => e.replace(/\s+/, "\\s+"))),
     /\b/
    );
   }
   const c = {
    ...
    keywords: {
     ...
     keyword: ((e, { exceptions: r, when: t } = {}) => {
      ...
      return (
       (r = r || []),
       e.map((e) =>
        e.match(/\|\d+$/) || r.includes(e) ? e : a(e) ? e + "|0" : e
       )
      );
     })(s, { when: (e) => e.length < 3 }),
